...
{
    // Keep engine types NinjaScript-free.
    // If you want to use these in NinjaScript, just include this namespace.
    ...
    public enum PriceCase
    {
        ...
        // Translations
        XB = 1,   // higher high AND higher low vs prior
        XR = 2,   // lower high AND lower low vs prior
    ...
    public readonly struct BarSnapshot
    {
        ...
        public readonly double O, H, L, C;
    ...
    {
        public readonly int BarIndex;       // bar where pivot is confirmed (center bar)
